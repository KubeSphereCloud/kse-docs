...
weight: 100
linkkey: compute_instances_nic_multi_faq
---
== 背景介绍
...
为了方便使用，我们提供了 link:../../other_questions/nic_mq.sh[网卡队列配置脚本] 配置这些参数，请把脚本放到 /etc/rc.local 中，开机自动配置。 详情请参考 link:https://www.kernel.org/doc/Documentation/networking/scaling.txt[linux network scaling]。
