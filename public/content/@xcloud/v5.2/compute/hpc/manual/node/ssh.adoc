...
. 点击已创建完成的集群 ID，进入集群详情页面，选择**节点列表**页签。 在**节点列表**页面，点击待重启节点所在行的image:/images/cloud_service/compute/hpc/more_operation.png[more_operation,60%]，选择 *WebSSH*。
+
image::/images/cloud_service/compute/hpc/ssh_1.png[ssh_1]
