...
. 选择**产品与服务** > *计算* > *高性能计算 HPC*，进入**集群**页面，点击**远程登录**。在弹出的**远程连接**窗口中，选择 *WebSSH 远程连接*，并输入用户名和密码，点击**确定**即可。
...
. 选择**产品与服务** > *计算* > *高性能计算 HPC*，进入**集群**页面，点击**远程登录**。在弹出的**远程连接**窗口中，选择 *VNC 连接*，点击**确定**。
+
