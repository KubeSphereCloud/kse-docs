...
. 登录管理控制平台。
. 选择**产品与服务** > *计算* > *高性能计算 HPC*，进入高性能计算 HPC 页面。
+
image::/images/cloud_service/compute/hpc/open_hpc_1.png[open_hpc_1]

. 勾选**服务协议**，点击**确定开通**，产品开始初始化配置。
+
image::/images/cloud_service/compute/hpc/open_hpc_2.png[open_hpc_2]

. 初始化配置完成后，进入**集群**页面。用户可根据需要创建 EHPC 集群。
