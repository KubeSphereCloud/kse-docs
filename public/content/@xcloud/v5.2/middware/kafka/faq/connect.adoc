...
* 方法一
+
通过 link:../../../../network/vpc/manual/tunnel/ipsec/[IPsec 隧道]、link:../../../../network/vpc/manual/tunnel/gre/[GRE 隧道] 等方式打通网络。
+
*适用场景*：这种方式适合于大规模复杂网络的情况。

* 方法二
+
配置 link:../../../../network/vpc/manual/vpn/[VPN]。
+
*适用场景*：这种方法通常用于本地开发测试。
...
*操作步骤*
+
*1*. 在 broker 所在的路由器上配置link:../../../../network/vpc/faq/methods_of_port_forwarding/[端口转发] 。 +
