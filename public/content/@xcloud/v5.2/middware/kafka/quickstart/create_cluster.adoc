...
image::/images/cloud_service/middware/kafka/kafka_node.png[]
...
image::/images/cloud_service/middware/kafka/client_node.png[]
...
image::/images/cloud_service/middware/kafka/network_setup.png[]
...
image::/images/cloud_service/middware/kafka/dependence_service.png[]
...
image::/images/cloud_service/middware/kafka/sevice_parameter.png[]

=== 第七步：用户协议

阅读**云平台 AppCenter 用户协议**，并勾选用户协议。

image::/images/cloud_service/middware/kafka/user_agreement.png[用户协议]
