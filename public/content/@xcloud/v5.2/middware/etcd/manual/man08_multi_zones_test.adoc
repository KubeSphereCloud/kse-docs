...
使用 etcd 中包含的 link:https://github.com/etcd-io/etcd/tree/master/tools/benchmark[benchmark] CLI 工具对 etcd 性能进行测试。不同的操作（Get, Set）分别定量处理，在客户端用操作成功的次数除以时间得到 TPS 。具体方法请参考 link:https://etcd.io/docs/v3.5/op-guide/performance/[官方文档]。
