...
. 点击link:https://yunify.anybox.qingcloud.com/s/8A0OKz2KhVJWfdYzSo1NLidpM1jDHFFq[此处]，下载 img.tar.gz。登录步骤 2 中的物理节点，拷贝 img.tar.gz 并解压至 `/root` 目录下。
+
[source,shell]
----
...
. 选择 virtio-win-0.1.171.zip 驱动所在目录，可参考 link:../preparation#_windows系统迁移前准备[Windows 系统迁移前准备]，点击**下一步**。
. 根据提示完成更新 virtio 驱动。
