...
+
image::/images/cloud_service/container/harbor/man05_node_tab.png[man05_node_tab]

 ** 右键单击节点，可修改节点名称。
 ** 单击**新增节点**，可按您的实际需要新增主服务节点和任务节点。

* 在页面右侧的**配置参数**页签，可查看和link:../man08_mdy_para/[修改参数值]，以更新集群配置。
+
image::/images/cloud_service/container/harbor/man05_custom-parameter.png[parameter]

* 在页面右侧的**告警**页签，可查看节点告警信息、配置告警通知策略、绑定指标告警策略。
+
image::/images/cloud_service/container/harbor/man05_alarm_tab.png[alarm_tab]
