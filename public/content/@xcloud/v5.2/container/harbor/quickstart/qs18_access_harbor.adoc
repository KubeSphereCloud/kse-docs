...
include::../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/container/harbor/qs18_harbor_url.png[harbor_url]
...
使用 Docker 前，请先下载及安装 Docker，具体操作请参见 https://docs.docker.com/get-docker/[安装 Docker]。
...
* `yourhub.domain.com` 表示 Harbor 的 IP 地址或 Domain 域名，必须与您在link:../../manual/man08_mdy_para/[参数配置页面]中的 **Harbor 地址**保持一致。
