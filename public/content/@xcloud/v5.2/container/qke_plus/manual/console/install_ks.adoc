...
创建集群时，在**对接服务**区域，选择安装可视化控制台 KubeSphere 或 QKCP。具体操作请参见link:../../../quickstart/create_selfmgt_cluster/[创建集群]。
...
默认最小化安装，若需要安装更多内置组件，请在控制台安装完成后，按需进行安装。具体操作请参见link:../install_component/[安装 KubeSphere/QKCP 内置组件]。
