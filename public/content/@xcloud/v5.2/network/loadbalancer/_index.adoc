...
title: 负载均衡器
weight: 50
description: 负载均衡器是将来自多个公网地址的访问流量分发到多台云服务器上的流量分发控制服务，并支持自动检测并隔离不可用的云服务器，从而提高业务的服务能力和可用性。
      ...
      - title: 使用问题
        children:
          ...
          - title: 如何分析 rsyslog 日志？
            url: faq/haproxy_log/
linkkey: network_loadbalancer_guide,network_loadbalancer_policies_guide,network_loadbalancer_server_certificates_guide
---
