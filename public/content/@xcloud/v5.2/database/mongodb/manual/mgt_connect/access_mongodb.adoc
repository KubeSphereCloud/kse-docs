...
* 已在服务器安装 https://docs.mongodb.com/manual/administration/install-on-linux/[Mongo Shell] 工具。为保障鉴权成功，请选择安装与 MongoDB 版本相对应的 Mongo Shell，安装说明请参见 https://docs.mongodb.com/manual/installation/?spm=a2c4g.11186623.0.0.78bd575fTyXmdC[Install MongoDB]。
...
更多参数说明，请参见 https://docs.mongodb.com/manual/reference/connection-string/[Connection String URI Format]。
