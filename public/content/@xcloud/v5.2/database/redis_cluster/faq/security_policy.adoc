...
+
image::/images/cloud_service/database/redis_cluster/set_passwd_1.png[设置密码,50%]
+
...
* *通过修改参数配置进行设置*
+
您还可以通过**参数配置**页面进行密码设置。具体方法可参考link:../../manual/cfginstance/paramconfig/[配置集群参数]。
+
image::/images/cloud_service/database/redis_cluster/set_passwd_2.png[设置密码,50%]

== 设置 TLS 加密

具体配置方法请参见link:../../best-practices/tls_config/[配置 TLS 加密]。
