...
* 已安装 Zabbix 客户端，并下载 https://releases-qs.pek3a.qingstor.com/zabbix/zbx_export_templates.xml?response-content-disposition=attachment[Percona Zabbix Templates]。
...
+
image::/images/cloud_service/database/mysql/enable_zabbix_agent.png[启动 Zabbix 客户端服务,50%]
. Zabbix Web 界面操作。
...
. 点击**提交**，关闭服务。
+
image::/images/cloud_service/database/mysql/disable_zabbix_agent.png[关闭 Zabbix 客户端服务,50%]
