...
* 已在服务器安装 Mongo Shell 客户端。为保障鉴权成功，请选择安装与 MongoDB 版本相对应的 Mongo Shell，安装说明请参见 https://docs.mongodb.com/manual/installation/?spm=a2c4g.11186623.0.0.78bd575fTyXmdC[Install MongoDB]。

include::../../../../../../_components/attention.adoc[]

当数据库与安装 Mongo Shell 的服务器不在同一 VPC 时，需使用 link:../../../../../network/vpc/manual/vpn/[VPN] 方式打通网络。
...
. 在**节点**页签，获取 Mongos 节点 IP 地址。
. 在**配置参数** 页签，获取 Mongos 节点端口号。
. 在**配置参数** 页签，获取 MongoDB 数据库 root 帐号密码。
+
若需修改 root 帐号密码，请参见link:../../config_para/config_para_info[公共参数]。

image::/images/cloud_service/database/mongodb_cluster/check_access_info.png[连接信息]
