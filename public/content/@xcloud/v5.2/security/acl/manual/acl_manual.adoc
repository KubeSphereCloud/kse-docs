...
draft: false
weight: 10
keyword: 云计算, 网络 ACL 基本操作, ACL 配置
...
. 登录管理控制台，选择**产品与服务** > *安全* > *网络访问控制*，进入**网络访问控制**页签。
...
+
image::/images/cloud_service/security/acl/create_acl_2.png[]
...
. 进入网络 ACL 详情页面，点击**添加规则**，您可以定义要添加的规则。
+
...
+
image::/images/cloud_service/security/acl/create_acl_5.png[]
+
...
+
image::/images/cloud_service/security/acl/create_acl_11.png[]
+
