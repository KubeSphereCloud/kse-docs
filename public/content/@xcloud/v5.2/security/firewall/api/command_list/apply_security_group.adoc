...
防火墙规则可通过 link:../add_security_group_rules/[_AddSecurityGroupRules_], link:../delete_security_group_rules/[_DeleteSecurityGroupRules_], link:../modify_security_group_rule_attributes/[_ModifySecurityGroupRuleAttributes_] 修改。
...
| String
| 应用防火墙的云服务器ID。 +
如果不传任何值，则会将最新规格更新到所有之前已应用此防火墙的云服务器。
| No
