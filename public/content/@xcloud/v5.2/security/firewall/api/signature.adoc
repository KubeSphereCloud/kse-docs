...
这里介绍 API 请求中签名 ( signature ) 的生成方法。您可以根据实际情况选择使用 *API 密钥* 或 link:../../../../authorization/iam/intro/intro/[IAM] *身份* 来完成签名。
...
image::/images/cloud_service/authorization/iam/iam_role.png[图片]
