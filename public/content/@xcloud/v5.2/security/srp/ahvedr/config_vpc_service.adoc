...
image::/images/cloud_service/security/srp/zjv1.png[图,50%]
...
+
image::/images/cloud_service/security/srp/zjv4.png[示例]

. 执行``./install_edr.sh``进行安装。
+
image::/images/cloud_service/security/srp/zjv5.png[安装]
...
+
image::/images/cloud_service/security/srp/zjv7.png[]

 .. 选择策略继承并输入策略名称，点击**确定**。
+
image::/images/cloud_service/security/srp/zjv8.png[确定]
...
+
image::/images/cloud_service/security/srp/zjv11.png[]
+
...
----
+
image::/images/cloud_service/security/srp/zjv12.png[端口扫描]
...
. 解除临时封锁IP。
 .. 选择**资产管理** > **资产概述**，点击待解除临时封锁IP的资产名称，进入资产详情页面。
+
...
+
image::/images/cloud_service/security/srp/zjv17.png[再次登录]
