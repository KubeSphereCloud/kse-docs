...
节点的 CPU 体系结构，可选值范围：Westmere、SandyBridge、IvyBridge、Haswell、Broadwell、Skylake、CascadeLake。 link:../../../../compute/vm/faq/common_operations/server_func/cpu_instruction_set/[查看对应的 CPU 指令集]
