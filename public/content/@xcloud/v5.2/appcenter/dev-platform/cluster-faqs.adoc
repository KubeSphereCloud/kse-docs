...
下载云平台提供的 App Ggent：link:../../dev-platform/cluster-developer-guide/scripts/app-agent-linux-amd64.tar.gz[Linux 版本] 与 link:../../dev-platform/cluster-developer-guide/scripts/app-agent-windows-386.zip[Windows 版本]。解压后运行 ./install.sh (Windows 下双击 install.bat)。
