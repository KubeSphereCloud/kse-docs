...
KubeSphere Enterprise adopts a fine-grained permission control mechanism. The {ks_product-en} web console varies based on the user's role.

This section, from the perspective of a user with the `platform-admin` role, introduces the modules and functionalities of the KubeSphere Enterprise web console.
