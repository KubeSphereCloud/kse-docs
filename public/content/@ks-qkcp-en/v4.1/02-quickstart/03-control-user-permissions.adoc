...
This section explains how to create users and control their permissions by roles in workspaces and projects. For more information on permission control, please refer to the "Users and Roles" guide.

The multi-tenant system of KubeSphere Enterprise consists of three levels: clusters, workspaces, and projects. You can create multiple workspaces within a KubeSphere Enterprise cluster, and multiple projects within a workspace. KubeSphere Enterprise provides built-in roles for workspaces and projects by default, and you can also create custom roles with specific permissions.

== Prerequisites

KubeSphere Enterprise has been installed.
