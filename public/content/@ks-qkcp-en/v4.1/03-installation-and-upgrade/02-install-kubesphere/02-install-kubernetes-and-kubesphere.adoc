---
title: "Install Kubernetes and KubeSphere Enterprise"
keywords: "Kubernetes, KubeSphere Enterprise, Installation, Install KubeSphere Enterprise, Install Kubernetes"
...
* In a production environment, it is recommended to configure high availability for the KubeSphere Enterprise cluster in advance to avoid service interruption in the event of a single control plane node failure. For more information, please refer to the link:../../../03-installation-and-upgrade/01-preparations/03-configure-high-availability/[Configure High Availability].
+
--
// Note
...
* Click link:../../../03-installation-and-upgrade/03-upgrade-kubesphere/05-appendix-ks-core#_component_list[here] to view the extension list and get more information.
|===
