...
== Support Matrix of Extensions

KubeSphere Enterprise v4.1.1 supports Kubernetes versions 1.21~1.28 by default. This section provides detailed information about the Kubernetes versions supported by each component of KubeSphere Enterprise. To avoid compatibility issues during usage, please use the supported Kubernetes version.

[%header,cols="2a,2a,3a,2a"]
|===
|Component |Component Version |Supported Kubernetes Versions |Supported Architectures
