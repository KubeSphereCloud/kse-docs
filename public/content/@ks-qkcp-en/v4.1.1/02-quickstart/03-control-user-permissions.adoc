...
// For more information on permission control, please refer to link:https://www.kubesphere.io/docs/v3.4/quick-start/create-workspace-and-project/[Users and Roles].

As a multi-tenant system, KubeSphere Enterprise supports controlling user permissions based on roles at the platform, cluster, workspace, and project levels, achieving logical resource isolation.

== Prerequisites

Have KubeSphere Enterprise installed.
