---
title: "Online Installation of Kubernetes and KubeSphere Enterprise"
...
This section explains how to install Kubernetes and {ks_product-en} in an Internet-accessible environment.
...
include::../../../_custom-en/installationAndUpgrade/installationAndUpgrade-desc-systemRequirements.adoc[]
...
. Run the following command to create the installation configuration file **config-sample.yaml**:
+
--
// Bash
...
Replace <Kubernetes version> with the actual required version, for example **v1.27.4**. {ks_product-en} natively supports Kubernetes v1.23~1.32.
...
KubeSphere Core (ks-core) is the core component of {ks_product-en}, providing the fundamental runtime environment for extensions. After KubeSphere Core is installed, you can access the {ks_product-en} web console.
...
. By now, the {ks_product-en} web console only provides the core functionalities of {ks_product-en}. To access more features, you need to install extensions from the Extensions Center.
...
// . By now, the {ks_product-en} web console only provides the core functionalities of {ks_product-en}. To access more features, you need to link:../../../06-extension-user-guide/01-install-extensions/[install extensions] from the Extensions Center. For more information, refer to the {ks_product-en} Extension Management Guide.

endif::[]
+
Before using {ks_product-en} and its extensions, please first link:../03-activate-kse/[activate KubeSphere Enterprise and extensions].
