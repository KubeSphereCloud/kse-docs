...
keywords: "Kubernetes, KubeSphere, quick start, install components, example, DevOps, extension features"
description: "Introduce all extensions and demonstrate how to install extensions."
weight: 02
---
...
include::../../_custom-en/extensionIntro/extension-intro-kse.adoc[]

== Install Extensions

include::../../_custom-en/extensionInstall/install-all-extensions.adoc[]
