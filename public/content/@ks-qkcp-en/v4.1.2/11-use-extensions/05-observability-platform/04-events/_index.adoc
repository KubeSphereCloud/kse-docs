...
* The **Log Receivers** option will be displayed under the **Cluster Settings** menu in the left navigation pane, and the **Log Receivers** page will display the **Resource Events** tab, supporting the addition of various types of log receivers. For more information, see link:../03-logging/06-log-receivers/[Log Receivers].
