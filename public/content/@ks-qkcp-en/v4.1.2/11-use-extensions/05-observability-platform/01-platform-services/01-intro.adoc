...
* Modify the extension configuration of WhizardTelemetry Platform Service in conjunction with WhizardTelemetry Monitoring to enable the Whizard Observability Center. For more information, see link:../../08-whizard/01-enable-whizard/[Whizard Observability Center].
...
// |
// 修改 WhizardTelemetry 平台服务的扩展组件配置，可配合 WhizardTelemetry 监控扩展组件，启用 Whizard 可观测中心。有关更多信息，请参阅 link:../../08-whizard/01-enable-whizard/[Whizard 可观测中心]。
// |===
