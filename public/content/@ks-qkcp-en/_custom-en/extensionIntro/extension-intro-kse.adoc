...
.12+|WhizardTelemetry Observability Platform
...
// 比 KubeSphere 多了 8 个组件，分别是审计、事件告警、应用路由工具、dmp、Spring Cloud、OAuth2-Proxy、NVIDIA GPU Operator、证书管理
// 注意每个分类前面的合并单元格的数字与 KubeSphere 的不同