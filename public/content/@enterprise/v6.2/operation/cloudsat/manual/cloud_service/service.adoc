...
云服务监控支持应用服务的监控，用户可以在云监控中查看账户下的集群和部分应用的监控数据，并支持多维度设置告警策略。

== 查看监控信息


. 用户登录云平台的{console_name}后，点击**产品与服务** > **运维与监控** > **云监控 CloudSat** > **云服务监控**，默认进入**负载均衡**监控列表页面。

. 在左侧导航栏点击**云服务监控** > **应用服务**，进入**应用服务**监控列表页面。该页面列举当前账户下已创建的所有应用服务。
+
