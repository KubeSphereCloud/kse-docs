...
draft: false
---
将一个私有网络连接到一台 VPC 网络，使得私有网络被 VPC 管理起来， 私有网络里的{instance_product_name_cn}也将获得 DHCP 自动分配地址的能力。

include::../../../../../_components/note.adoc[]
私有网络只能连接到状态为 active 和 poweroffed 的 VPC 网络。
...
[source]
----
https://api.domain.com/iaas/?action=JoinRouter
&vxnet=vxnet-rzg2llb
&router=rtr-xt37nm9j
