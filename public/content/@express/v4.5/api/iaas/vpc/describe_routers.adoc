...
可根据 VPC 网络ID、状态、VPC 网络名称作过滤条件，来获取 VPC 网络列表。 

include::../../../../../_components/note.adoc[]
* 如果不指定任何过滤条件，默认返回你所拥有的所有 VPC 网络。 
* 如果指定不存在的 VPC 网络ID，或非法状态值，则会返回错误信息。
...
[source]
----
https://api.domain.com/iaas/?action=DescribeRouters
