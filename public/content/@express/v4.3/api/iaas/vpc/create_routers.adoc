...
创建一个或多个 VPC 网络。 VPC 网络用于受管私有网络之间互联，并提供 DHCP 服务、端口转发等功能。

include::../../../../../_components/note.adoc[]
* 该 API 只负责 VPC 网络的创建工作，如果需要通过 VPC 网络将自己名下的受管私有网络连接起来，请查看 link:../join_router/[_JoinRouter_]。
* 如果需要配置端口转发规则，请查看 link:../add_router_statics/[_AddRouterStatics_] 和 link:../update_routers/[_UpdateRouters_]。
...
[source]
----
https://api.domain.com/iaas/?action=CreateRouters
&router_name=demo
&zone=testa
&COMMON_PARAMS
----
