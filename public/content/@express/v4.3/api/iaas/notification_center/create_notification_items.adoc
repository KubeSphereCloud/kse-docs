...
* 如果通知项的内容（content）是第一次创建，需要经过验证才能接收通知，可参考 link:../verify_notification_item/[VerifyNotificationItem]。
* 如果已创建并验证过相同的内容，那么不需要再次验证。
...
----
https://api.domain.com/iaas/?action=CreateNotificationItems
