...
. 在**节点**页签，点击**新增节点**，弹出节点配置窗口。
+
image::/images/cloud_service/bigdata/kyligence/add_node.png[增加节点]
...
. 在集群详情页面，点击**基本属性**模块下拉菜单栏。
. 展开菜单栏，点击**扩容集群**，弹出扩容集群配置窗口。
. 配置待扩容集群信息。
+
配置节点 CPU、内存和磁盘大小。
+
image::/images/cloud_service/bigdata/kyligence/scale_up_down.png[扩容节点]
