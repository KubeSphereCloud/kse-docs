...
开始配置 PostgreSQL 数据源前，请先添加数据源，详细操作请参见link:../../../source_data/add_data/postgresql[新增 PostgreSQL 数据源]。
...
image::/images/cloud_service/bigdata/dataomnis/cfg_source_postgresql01.png[配置 PostgreSQL 数据来源]
...
image::/images/cloud_service/bigdata/dataomnis/cfg_source_postgresql.png[配置 PostgreSQL 数据来源-增量]
