...
更多详细信息请参见 https://nightlies.apache.org/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#%E6%A0%87%E9%87%8F%E5%87%BD%E6%95%B0[Flink 官方文档]。
...
. 编写自定义函数代码，详细请参见 Flink 官方文档中的 https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#开发指南[UDF 开发指南]。
+
...
. 上传程序包 +
 在资源管理界面，上传自定义函数的 JAR 程序包。详细操作请参见link:../../manual/resource/upload[上传程序包]。
. 声明 UDF
+
