...
详细信息请参考：link:https://debezium.io/documentation/reference/1.5/connectors/mysql.html#mysql-creating-user[权限说明]。
...
| UTC
| String
| 会话时区，例如："Asia/Shanghai"。控制 MYSQL 中的 TIMESTAMP 类型如何转换为 STRING。详细请参考link:https://debezium.io/documentation/reference/1.2/connectors/mysql.html#_temporal_values[官方文档]。
...
| 无
| String
| 传递 Debezium 的属性，如：`'debezium.snapshot.mode' = 'never'`。更多信息请查看 https://debezium.io/documentation/reference/1.2/connectors/mysql.html#mysql-connector-configuration-properties_debezium[Debezium 的 MySQL 连接器属性]。
|===
