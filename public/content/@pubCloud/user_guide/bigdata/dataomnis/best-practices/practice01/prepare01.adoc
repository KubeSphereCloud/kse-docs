...
. link:../../../../../database/mysql/quickstart/create_cluster/[创建 MySQL Plus 集群]。
. link:../../../../../database/mysql/quickstart/create_account/[创建数据库账号]。
+
...
. link:../../../../../database/mysql/quickstart/access_mysqlplus/[连接数据库]。
...
详细操作请参见：link:../../../../elk/quickstart/create_cluster/[创建 ELK 集群]。
