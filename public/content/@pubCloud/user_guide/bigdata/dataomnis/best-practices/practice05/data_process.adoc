...
更多相关参数请参见 link:../../../developer_sql/connector/kafka[Kafka] 和 link:../../../developer_sql/connector/clickhouse[ClickHouse]。
...
+
image::/images/cloud_service/bigdata/dataomnis/bp_job_enviroment_sql_01.png[运行参数]
