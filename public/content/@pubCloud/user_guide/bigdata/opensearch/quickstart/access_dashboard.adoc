...
更多 Dashboard 使用和功能介绍，请参见 link:https://opensearch.org/docs/latest/dashboards/index/[OpenSearch Dashboards]。
...
* 若需通过外网访问 OpenSearch Dashboards，请先通过设置link:../../../../network/border_router/[边界路由器]或 link:../../../../network/vpc/manual/vpn/vpn_intro[VPN] 等方式打通网络。
