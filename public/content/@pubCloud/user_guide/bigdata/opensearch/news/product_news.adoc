...
keywords: 产品动态,OpenSearch,搜索引擎,大数据
weight: 05
collapsible: false
draft: false
...
product:
    - time: 2023-03-14
      title: OpenSearch 2.3.0 - v1.0.0 版本正式上线
      content: OpenSearch 服务新版本上线，基于原生 OpenSearch 2.3.0 内核版本构建。<br>- OpenSearch REST API 支持开启 HTTPS。<br>- OpenSearch REST API 支持使用自定义证书。<br>- 支持客户端证书认证。<br>- 支持 Keystore 功能。
      url: ../../intro/function/
      tags:
      - 新功能
      zone: 全区域 
