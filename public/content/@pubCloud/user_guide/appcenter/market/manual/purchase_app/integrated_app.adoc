...
keywords:  AppCenter, 云市场, SaaS 应用
weight: 20
draft: false
---
== 查找 SaaS 应用
...
* 登录https://marketplace.qingcloud.com/[云市场]，进入云市场，可查看 QingCloud 出品的 SaaS 应用。
+
image::/images/cloud_service/appcenter/um_saas_app.png[]

* 登录 https://console.qingcloud.com/[QingCloud 管理控制台]，在 AppCenter 控制台的**应用中心**或者**产品与服务**，快速查看所需的 SaaS 应用。
+
image::/images/cloud_service/appcenter/um_saas_appcenter.png[]

== 购买 SaaS 应用

如下**以登录 QingCloud 管理控制台开通 SaaS 应用为例**进行说明。

. 在应用详情中，点击**立即开通** (或 *立即购买*），进入应用开通或应用购买页面。
+
