...
更多青云制作的应用可以在link:https://github.com/qingCloudAppcenter/[这里]找到。常见的问题请参考link:../../cluster-faqs[常见问题]。

具体步骤可以参考视频教程：+++<video src="https://appcenter-docs.pek3a.qingstor.com/developer-guide/docs/videos/AppCenter2.0_Training_Fix.mp4" controls="controls">+++您的浏览器不支持 video 标签。+++</video>++++++<video src="https://appcenter-docs.pek3a.qingstor.com/developer-guide/docs/videos/tomcatdemo_720p.mp4" controls="controls">+++您的浏览器不支持 video 标签。+++</video>+++
