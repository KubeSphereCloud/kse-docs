...
+
image::/images/cloud_service/authorization/vdc/edit_org.png[修改组织]
...
+
image::/images/cloud_service/authorization/vdc/change_members.png[修改组织成员]
. 找到需要删除的成员，记录成员名称。
...
+
image::/images/cloud_service/authorization/vdc/change_quota.png[修改组织配额]
