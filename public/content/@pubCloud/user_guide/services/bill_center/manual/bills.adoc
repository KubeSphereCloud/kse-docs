...
draft: true
keywords: 云计算, 费用中心,消费账单, 账单总览, 消费明细, 消费预估
---
...
* 查看消费明细：选择时间及过滤条件后，页面下方即可显示满足条件的消费统计图表，默认显示柱状图统计。在统计图右上方，可点击image:/images/cloud_service/services/bill_center/line_static.png[]图标切换为折线图形式。
