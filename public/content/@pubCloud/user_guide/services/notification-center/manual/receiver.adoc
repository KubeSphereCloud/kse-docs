...
. 在弹出的**新增接收人**窗口中，输入**接收人姓名**、**邮箱**、**手机号**等信息。
+

include::../../../../../_components/note.adoc[]
请至少填写一个联系方式，如手机号、邮箱或高级选项中的 Webhook 地址。
...
. 点击待删除的接收人右侧的**删除**。
+
image::/images/cloud_service/services/notification-center/delete_receiver.png[delate_receiver ]
