...
video_section:
  - title: 
    children:
      - title: 跨区域（Region）VPC 互联
        time_duration: 49:00
        # poster: "https://s6.jpg.cm/2021/11/0K1qV.png"
        url: "https://yunify-qingcloud-docs.pek3b.qingstor.com/video/qs_sdwan_cross_vpc_access_2023.mp4"
        description: 演示如何通过 SD-WAN 实现跨区域的 VPC 互联。
---
