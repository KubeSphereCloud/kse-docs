...
. 升级负载均衡器。
+
部分用户使用的 LB 为较早之前创建的，镜像版本不支持开启 HTTP2.0 ，此时可以进入相应 LB 的详情页面，点击**基本属性**的下拉框，并选择**版本检查**进行升级。
+
image::/images/cloud_service/network/lb/http2_enabled_does_not_take_effect_2.png[,50%]
