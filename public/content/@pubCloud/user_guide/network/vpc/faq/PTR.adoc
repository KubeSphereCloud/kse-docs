---
title: "如何开启/关闭 PTR 记录"
description: 介绍如何在 DNS 服务中开启及关闭 PTR 记录。
keywords: VPC 网络, DNS, PTR
draft: false
weight: 40
---
...
VPC 网络内网 DNS 服务功能可以对 VPC 内部提供域名解析的服务，支持开启/关闭内网 DNS 服务，同时支持开启/关闭 PTR 解析类型-反向 DNS 解析。

在 VPC 网络详情页的**管理配置**页签，选择 **DNS 服务** > **打开 DNS 服务**，然后可选择是否开启 PTR 记录。

image::/images/cloud_service/network/vpc/ptr_1.png[ptr_1]

include::../../../../../_components/attention.adoc[]

* 关闭 DNS 功能, 需要让云服务器重新获取 DHCP 解析, 更新本地 DNS 地址后才能生效。
* 开启 DNS 功能, 需要让云服务器重新获取 DHCP 解析, 更新本地 DNS 地址后才能生效。
* 关闭/开启 DNS 功能，开启/关闭 PTR 功能后，都需要点击 vi etc/passwd 的应用修改。
