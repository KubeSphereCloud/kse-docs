...
. 在**新增黑名单**对话框中，按照界面提示新增新增黑名单。
+
image::/images/cloud_service/security/firewall/black_list.png[黑名单,60%]
...
. 在**新增白名单**对话框中，按照界面提示新增白名单。
+
image::/images/cloud_service/security/firewall/white_list.png[白名单,60%]
