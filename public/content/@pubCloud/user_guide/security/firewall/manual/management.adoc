...
+
image::/images/cloud_service/security/firewall/add_address.png[新增地址簿,50%]
...
. 在控制台产品服务列表打开**安全服务**中的**云防火墙 CFW**，进入云防火墙控制台。
. 在左侧导航栏，单击**安全策略** > *通用管理* > *服务端口*。
. 在**服务端口**页面，选择**自定义服务端口**。
+
image::/images/cloud_service/security/firewall/server.png[]

. 在**新增自定义服务端口**对话框中，按照界面提示填写自定义服务端口信息。
+
image::/images/cloud_service/security/firewall/default_port.png[,50%]
