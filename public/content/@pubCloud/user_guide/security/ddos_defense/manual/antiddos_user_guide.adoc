...
image::../../_images/main_page.png[]

点击 *购买* 进入如下界面

image::../../_images/create.png[]
...
image::../../_images/create_cdn_2.png[]
...
image::../../../_images/create_cdn_4.png[]
...
image::../../../_images/dnspod_main.png[]

如下图，www 的 A 记录已经暂停：

image::../../../_images/dnspod_stopped.png[]

在 DNSPod 重新配置 www 的 CNAME 记录，记录值则指向青云提供的 CNAME 值。如下图：

image::../../../_images/dnspod_add.png[]
...
image::../../../_images/monitor_connection_number.png[]

流量监控

image::../../../_images/monitor_bandwidth.png[]
