...
. 下载安装
+
qsftpd 支持 Linux、MacOS 和 Windows 操作系统，可访问 GitHub 项目的 link:https://github.com/yunify/qsftpd/releases[Releases] 页面查看和下载历史版本。Linux 最新版本下载链接：link:https://pek3a.qingstor.com/releases-qs/qsftpd/qsftpd-latest-linux_amd64.tar.gz[qsftpd-latest-linux_amd64]。
...
----
+
可以参考此配置（access_key_id、secret_access_key、bucket_name、zone 需要自行填写）：
+
[,yaml]
----
