...
. 填写名称、选择安置策略组关系
+
image::/images/cloud_service/compute/instance_group/manual_instance_group_1.png[,60%]
+
...
image::/images/cloud_service/compute/instance_group/manual_instance_group_2.png[,60%]
...
image::/images/cloud_service/compute/instance_group/manual_instance_group_3.png[,60%]
