...
在创建云服务器，进行配置信息设置时，可以选择镜像，如下图所示：

image::/images/cloud_service/compute/image/intro_image_1_pub.png[]
...
video::https://s4.qingcloud.com/files/2023/02/公有云2023快速上手_100P004U202302_制作自有镜像.mp4[制作自有镜像]
