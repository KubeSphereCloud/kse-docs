...
+
image::/images/cloud_service/compute/image/manual_image_1.png[,60%]

. 待备份完成之后，在控制台上选择 *存储* > *备份*，找到之前的备份，并右键选择 *制作新镜像*。 
+
image::/images/cloud_service/compute/image/manual_image_2.png[,60%]
...
. 挂载到云服务器的硬盘必须是本地盘，云盘不支持通过备份创建镜像。关于本地盘和云盘的详细信息，请参见link:../../../../storage/disk/intro/introduction/#硬盘类型[硬盘类型]。
