...
推流是指将主播端采集的音视频信息推送至{platform_shortname}。
...
在{platform_shortname}完成域名添加后，系统自动为添加的域名分配的一个 CNAME 记录。您需要在您的域名服务提供商处配置 CNAME 记录。配置生效后，域名解析至{platform_shortname}视频直播服务。
