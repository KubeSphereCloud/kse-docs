...
+
image::/images/cloud_service/container/harbor/faq02_login_vnc.png[faq02_login_vnc,50%]
...
由于资源主机所在网络无法直接与外网连通，所以需要配置 link:/user_guide/network/vpc/manual/vpn/use_openvpn/[VPN] 或配置 VPC 端口转发。
