...
+
其中，工作节点分为工作节点-基础型、工作节点-企业型及工作节点-GPU：
+
** 工作节点-基础型：节点的实例规格类型为link:../../../../../compute/vm/intro/type/basic/[基础型]。
** 作节点-企业型：节点的实例规格类型为link:../../../../../compute/vm/intro/type/calculate[计算型 ec3]。
** 工作节点-GPU：节点的实例规格类型为 link:../../../../../compute/vm/intro/type/gpu[GPU 加速型]，支持多卡 GPU 主机。
