...
draft: false
weight: 25
keywords: 容器,QKE,KubeSphere,QKCP
---
...
. 点击**升级** > *升级 KubeSphere 新版本*，弹出升级对话框。
+
image::/images/cloud_service/container/qke/upgrade_ks.png[]

. 选择升级版本，点击**升级**。等待升级成功即可。
+
image::/images/cloud_service/container/qke/upgrade_ks_2_q.png[,50%]
+
