...
更多详细说明，请参见link:../../../intro/introduction/#_产品形态[产品形态]。

== 操作步骤

创建不同版本的集群时，需要配置的集群信息有所不同。

* 创建托管版集群，请参见link:../../../quickstart/create_hosting_cluster/[创建 QKE 托管版集群]。
* 创建自管版集群，请参见link:../../../quickstart/create_selfmgt_cluster/[创建 QKE 自管版集群]。
