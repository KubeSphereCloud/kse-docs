...
weight: 5
keywords: QKE, 常见问题
linkkey: qke_doc_question_more_help_faq,qke_doc_question_5_faq,qke_doc_deploy_ks_faq,qke_doc_more_help_faq
---
// ## 能否创建单节点集群？
...
能。如果您需要安装 KubeSphere，可以在创建集群时选择安装，也可以在集群创建后安装。具体操作，请参见link:../../manual/console/install_ks/[安装 KubeSphere 可视化控制台]。
