...
product:
  ...
  - time: 2023-12-30
    title: QKE v3.1 发布，新增支持 Contained 配置
    content: QKE v3.1 上线。<br/>- Kubernetes 版本升级至 1.25.10 版本。<br/>- 增加 Kubelet 根目录创建设置。<br/>- 优化创建集群的 Kernal 参数。<br/>- 修复已知问题，提升用户体验。
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区

  - time: 2022-11-24
    title: QKE v2.3.2 发布，新增集群维度“物理资源监控”
    content: QKE v2.3.2 上线。<br/>- 支持对接使用开启了 TLS 的 Etcd 集群，增强集群的数据安全性。<br/>- 新增集群维度“物理资源监控”，提升可观测性。<br/>- 修复了一些问题，提升用户体验。
    url: ../../manual/om_mgt/monitor/index_desc/
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区
  - time: 2022-11-02
    title: QKE v2.3.1 发布，新增集群节点资源预留
    content: QKE v2.3.1 上线。<br/>- 新增集群节点资源预留。<br/>- 重构了可视化控制台访问方式的功能，支持集群内部网络访问和外部网络访问两种方式。<br/>- 其他优化和问题修复，提升产品安全性和资源管理能力。
    url: ../../manual/mgt_node/node_reserve/
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区
  - time: 2022-09-08
  ...
  - time: 2022-08-11
    ...
    url: ../../manual/mounting_resource/view_resource/
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区
  - time: 2022-07-29
    ...
    url: ../../manual/om_mgt/alarm/alarm_index/
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区
  - time: 2022-07-15
  ...
  - time: 2022-06-15
    ...
    content: QKE v1.2.2 上线。<br/>- 新增集群节点重启功能，提供节点异常快速修复办法。<br/>- qingcloud-csi
      部署调整，修复多可用区部署时磁盘挂载问题。<br/>- 修复了一些 bug，如集群 PVC 用量更正等。<br/>
    url: ../../manual/mgt_node/restart_node/
    tags:
      - 新功能
    zone: 北京3区，上海1区，广东2区
  - time: 2022-05-10
    title: QKE v1.1.0 发布，新增自管版集群形态
    content: QKE v1.1.0 上线。<br/>- 新增自管版集群形态，可创建 Master 节点自行管理的自管版 QKE 集群。<br/>-
      新增集群内节点级别的监控功能，可对 Worker 节点 CPU、内存等进行监控，掌握计算资源实时负载。<br/>- 支持对接独立部署的 ELK
      集群存储集群日志，保障高可用服务。<br/>- 修复了一些 bug，提升集群稳定性。
