...
draft: false
weight: 1
keywords: 青云, QingCloud, QKE, 常见问题 
---
== 能否创建单节点集群
...
image::/images/cloud_service/container/qke_old/sc.png[存储类型]
...
* 如果使用私有镜像仓库，比如青云提供的 link:/user_guide/container/harbor/intro/introduction/[Harbor 镜像仓库]，请确保 QKE 所有节点可以访问到 Harbor 的负载均衡器地址。
+
