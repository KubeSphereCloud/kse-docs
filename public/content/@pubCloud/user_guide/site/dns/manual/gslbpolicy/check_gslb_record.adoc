...
+
image::/images/cloud_service/site/dns/gslb_policy_list.png[GSLB 策略列表]
...
+
image::/images/cloud_service/site/dns/gslb_alarmlog.png[查看策略日志列表]

. 选择目标日志，点击**查看**，展开日志详情。
+
可查看该 IP 各监控节点，检测状态和日志详情。
+
image::/images/cloud_service/site/dns/gslb_alarmlog_detail.png[查看策略日志详情,70%]
