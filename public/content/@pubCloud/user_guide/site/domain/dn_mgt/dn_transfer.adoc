...
. 在域名列表中，找到要过户的域名，点击操作列下的**管理**，进入基本信息页面。
+
image::/images/cloud_service/site/domain/dn_list.png[]

. 点击**过户/更换模版**，进入过户页面。
+
image::/images/cloud_service/site/domain/dn_transfer.png[]
...
+
image::/images/cloud_service/site/domain/dn_transfer_complete.png[]
