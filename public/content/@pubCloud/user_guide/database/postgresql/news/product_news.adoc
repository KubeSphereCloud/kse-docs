...
keywords: 产品动态,PostgreSQL,关系型数据库,数据库
weight: 05
collapsible: false
draft: false
...
product:
    - time: 2024-03-06
      title: PG V2.4.0-高可用版/基础版正式上线
      content: PostgreSQL PG V2.4.0-高可用版/基础版 新上线。<br>- 增加多可用区部署功能。<br>- 修复因插件冲突引起 PostgreSQL 15 版本 drop database 卡住的问题。<br>- 增加 pgrouting 插件。
    ...
    - time: 2023-09-27
      title: PG V2.3.0-高可用版/基础版正式上线
      content: PostgreSQL PG V2.3.0-高可用版/基础版 新上线。<br>- 支持灾备集群的设置。<br>- 支持 SSL 加密传输。<br>- 支持 pgvector 插件。

      url: ../../manual_new/disaster_recovery/overview/
      tags:
      - 新功能
      zone: 全区域

    - time: 2023-06-15
      title: PG V2.2.0-高可用版/基础版正式上线
      content: PostgreSQL PG V2.2.0-高可用版/基础版 新上线。<br>- 升级 PostgreSQL 15 内核至 15.3。<br>- 支持 aws_s3 插件，即支持从对象存储导入/导出数据。<br>- 支持 pgaudit 插件。<br>- 修复网段冲突导致 VIP 不可用的问题。<br>- V2.2.0-高可用版新增指定 Master 节点功能，支持手动切换主节点。

      url: ../../manual_new/node_lifecycle/switch_node/
      tags:
      - 新功能
      zone: 全区域
