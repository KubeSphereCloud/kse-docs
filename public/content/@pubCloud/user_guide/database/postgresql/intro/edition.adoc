...
基于 PostgreSQL 12.12 、13.8、14.5、15.3 内核版本分别构建了 PostgreSQL V2.2.0 以及 V2.3.0 高可用版和基础版。
...
* PostgreSQL 高可用版 -V2.3.0  
* PostgreSQL 高可用版 -V2.4.0  
...
* PostgreSQL 基础版 -V2.3.0 
* PostgreSQL 基础版 -V2.4.0   
|===
...
=== PostgreSQL 高可用版/基础版-V2.4.0

基于 PostgreSQL 12.12 、13.8、14.5、15.3 内核版本分别构建的高可用版和基础版。

* 增加link:../../quickstart/create_cluster_new/[多可用区部署]功能。
* 修复因插件冲突引起 PostgreSQL 15 版本 drop database 卡住的问题。
* 增加 pgrouting 插件。

=== PostgreSQL 高可用版/基础版-V2.3.0

基于 PostgreSQL 12.12 、13.8、14.5、15.3 内核版本分别构建的高可用版和基础版。

* 支持link:../../manual_new/disaster_recovery/overview/[灾备集群]的设置。
* 支持 link:../../manual_new/data_safety/ssl_enable/[SSL 加密传输]。
* 支持 pgvector 插件。
