...
只有选择部署在**区域**时，才可以选择部署方式。目前仅``北京3区``支持配置``多可用区部署``。
...
只有选择部署在**区域**时，才可以选择``企业级分布式 SAN (NeonSAN)``。目前可选择区域有``上海1区``、`广州2区`、`北京3区`。
...
您也可以参考以下视频学习 MySQL Plus 的创建及使用。

video::http://s4.qingcloud.com/files/2023/03/%E5%85%AC%E6%9C%89%E4%BA%912023%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B_100P018U202303_%E5%88%9B%E5%BB%BA%E5%92%8C%E4%BD%BF%E7%94%A8%20MySQL%20Plus.mp4[创建和使用 MySQL Plus]