...
keywords: 数据库，ClickHouse，数据仓库，产品动态
weight: 05
collapsible: false
draft: false
...
product:
    - time: 2023-12-27
      title: ClickHouse 1.2.0 版本正式上线
      content: ClickHouse 1.2.0 新上线。<br>- 升级内核至 22.3.20（修复22.3.6内存泄漏问题）。<br>- 增加多可用区部署功能。<br>- 修复切换私有网络节点状态异常的问题。<br>- 完善日志管理功能。
      url: ../../intro/version/
      tags:
      - 新功能
      - 体验优化
