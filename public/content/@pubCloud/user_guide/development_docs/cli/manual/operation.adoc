...
description: test
draft: false
keywords: CLI配置, QingCloud, 青云, CLI文档, CLI
---
== 命令自动补全
...
access key 可在 link:https://console.qingcloud.com/access_keys/[{console_name}]申请。zone 是你的资源所在的节点，可在控制台切换节点的地方查看，如 pek3, gd2, ap2a 等。
