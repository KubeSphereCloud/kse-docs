...
在使用对象存储之前，建议用户对 Bucket、Object、Zone、访问域名等基本概念先进行了解，以便更好的理解与使用对象存储的功能。详情可参考 link:../../intro/product/#_基本概念[基本概念]。
...
* link:../../manual/console/bucket_manage/access_control/#_使用示例/[设置防盗链]
