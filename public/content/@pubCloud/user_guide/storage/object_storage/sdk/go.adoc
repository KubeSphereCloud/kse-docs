...
weight: 3
---
QingStor 对象存储的 Go SDK 已在 GitHub 开源，本文为简要使用文档。更多详细信息请参见 https://github.com/qingstor/qingstor-sdk-go[GitHub 项目]和 https://godoc.org/github.com/qingstor/qingstor-sdk-go[Godoc]。
