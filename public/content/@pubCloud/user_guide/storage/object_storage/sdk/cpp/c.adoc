...
---
在开始使用 SDK 之前，请确认您已经了解 link:../../../intro/product/#_基本概念[QingStor 对象存储基本概念]，如 Zone，Service，Bucket，Object 等。
...
所有的 API 调用接口均与上面的示例相似，用户可以查看 link:../../../api/[QingStor 对象存储API 文档]来了解更多信息。
