...
draft: false
weight: 13
linkkey: storage_qingstor_worm_manual
---
...
* 示例二
+
假设您在 2023年06月01日 为您账号下的某个 Bucket 创建了保护周期为 30天 的**桶级别锁**后，又在 2023年06月28日 修改了该 Bucket 的的保护周期为 40天。您在不同时间上传了 test_file1.txt、test_file2.txt、test_file3.txt 三个 Object。关于这三个 Object 的具体上传时间以及对应的到期时间说明如下。
...
| test_file1.txt | 2023年04月01日 00:00:00 | 2023年04月30日 24:00:00
| test_file2.txt | 2023年06月01日 00:00:00| 2023年07月10日 24:00:00
| test_file3.txt | 2023年07月01日 00:00:00| 2023年08月10日 24:00:00
...
**对象版本锁**设置后，是对后续上传的对象生效。`test_file1.txt` 上传的时间早于**对象版本锁**设置的时间，因此该保留策略对其不生效。

include::../../../../../../../_components/table_footer.adoc[]

* 示例四
+
假设您在 2023年06月01日 为您账号下的某个 Bucket 创建了保护周期为 30天 的**对象版本锁**后，又在 2023年06月18日 修改了该 Bucket 的的保护周期为 40天。您在不同时间上传了 test_file1.txt、test_file2.txt、test_file2.txt 三个 Object。关于这三个 Object 的具体上传时间以及对应的到期时间说明如下。
+
[cols='1,1,1']
|===
| 对象名称 | 上传时间 | 到期时间 
...
| test_file1.txt | 2023年04月01日 | -
| test_file2.txt（版本一） | 2023年06月01日 00:00:00| 2023年06月30日 24:00:00
| test_file2.txt（版本二）| 2023年06月20日 00:00:00| 2023年07月30日 24:00:00
...
Bucket WORM API 见 API 文档 link:../../../../api/bucket/worm/[WORM 设置]。
...
| 设置 Bucket 桶级别锁
| link:../../../../api/bucket/worm/put_bucket_retention/[PUT Bucket Retention]
...
| 获取 Bucket 的 WORM 策略
| link:../../../../api/bucket/worm/get_bucket_retention[GET Bucket Retention]
| 用于获取 Bucket 已设置的 WORM 策略

| 锁定 Bucket 桶级别锁的保留策略
| link:../../../../api/bucket/worm/post_bucket_retention/[POST Bucket Retention]
| 用于锁定 Bucket 已设置的桶级别锁的保留策略

| 设置对象版本锁
| link:../../../../api/object/object_lock/put_object_lock_configuration/[PUT ObjectLockConfiguration]
| 用于设置对象版本锁
