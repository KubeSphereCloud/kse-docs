...
| link:../../../../api/bucket/replication/put_replication[PUT Bucket Replication]
| 用于设置 Bucket 跨区域复制规则

| 获取 Bucket Replication
| link:../../../../api/bucket/replication/get_replication[GET Bucket Replication]
| 用于获取已有的 Bucket 跨区域复制规则

| 删除 Bucket Replication
| link:../../../../api/bucket/replication/delete_replication[DELETE Bucket Replication]
| 用于删除已经设置的跨区域复制规则
|===
