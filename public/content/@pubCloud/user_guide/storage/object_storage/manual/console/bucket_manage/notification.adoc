...
| 设置 Bucket Notification
| link:../../../../api/bucket/notification/put_notification[PUT Bucket Notification]
| 用于设置 Bucket 事件通知规则

| 获取 Bucket Notification
| link:../../../../api/bucket/notification/get_notification[GET Bucket Notification]
| 用于获取已有的 Bucket 事件通知规则

| 删除 Bucket Notification
| link:../../../../api/bucket/notification/delete_notification[DELETE Bucket Notification]
| 用于删除已经设置的事件通知规则
|===
