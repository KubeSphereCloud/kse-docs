...
| 设置 Bucket Logging
| link:../../../../api/bucket/logging/put_logging[PUT Bucket Logging]
| 用于开启 Bucket 的日志归档功能

| 获取 Bucket Logging
| link:../../../../api/bucket/logging/get_logging[GET Bucket Logging]
| 用于获取 Bucket 的日志归档功能设置

| 删除 Bucket Logging
| link:../../../../api/bucket/logging/delete_logging[DELETE Bucket Logging]
| 用于关闭已经设置的 Bucket 日志归档功能
|===
...
* `<TargetPrefix>` 为在 {console_name}或者通过API设置的前缀。
