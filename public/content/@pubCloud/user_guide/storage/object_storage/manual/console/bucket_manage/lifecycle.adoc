...
对象存储定义生命周期为 Bucket 的设置项，因此，只有 Bucket 的所有者才能设置该功能。
...
| 设置 Bucket Lifecycle
| link:../../../../api/bucket/lifecycle/put_lifecycle[PUT Bucket Lifecycle]
| 用于设置 Bucket 的生命周期规则

| 获取 Bucket Lifecycle
| link:../../../../api/bucket/lifecycle/get_lifecycle[GET Bucket Lifecycle]
| 用于获取已设置的 Bucket 生命周期规则

| 删除 Bucket Lifecycle
| link:../../../../api/bucket/lifecycle/delete_lifecycle[DELETE Bucket Lifecycle]
| 用于删除已经设置的 Bucket 策略生命周期规则
|===
