...
|
请务必把该值设为 true。否则，后续操作将还原所有 OpenSearch 集群的用户、角色、密码等设置。
...
image::/images/dmp/os-certificate.png[]
--
...
image::/images/dmp/certificate-details.png[]
...
image::/images/dmp/verify-certificate.png[]
--
...
image::/images/dmp/os-external.png[]
--
