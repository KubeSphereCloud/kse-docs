...
* 已获取{ks_product_both}平台登录账号和密码，且已获取平台管理权限。
...
+
--
image::/images/dmp/download-CA-user-certificate.png[]
--
...
image::/images/dmp/kakfa-index.png[]
--
...
image::/images/dmp/kafka-input-success.png[]
--
