...
* 您需要联系{ks_product_both}的交付服务专家获取{ks_product_left} v4.1.0 安装包。
...
[,bash]
----
certutil -hashfile C:\Users\user1\Downloads\kse-v4.1.0-offline-linux-amd64-all-20240515.tar.gz SHA256
----
--
...
[,bash]
----
sha256sum ~/Downloads/kse-v4.1.0-offline-linux-amd64-all-20240515.tar.gz
----
--
...
[,bash]
----
shasum -a 256 ~/Downloads/kse-v4.1.0-offline-linux-amd64-all-20240515.tar.gz
----
--
====

. 与以下 SHA256 值进行比对，确保上一步得到的 SHA256 与其一致。
+
--
amd64 和 arm64 架构的安装包 SHA256 值分别如下：

* amd64_x86
+
sha256: 140e61fc86b009167dcd7c9a7ec6c2c8269faa036caf1ec73f8106fed9aa302e
kse-v4.1.0-offline-linux-amd64-all-20240515.tar.gz  
 
* arm64
+
sha256: 8d5345d7b18512df48916e23b0f610f5d3fc42f6d84580335cee414d6a5947f3
kse-v4.1.0-offline-linux-arm64-all-20240515.tar.gz
--
...
[,bash]
----
kse-v4.1.0-offline-linux-amd64-all/
├── charts
