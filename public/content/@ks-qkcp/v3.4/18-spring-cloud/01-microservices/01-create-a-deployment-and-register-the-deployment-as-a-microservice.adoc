...
// :ks_include_id: cb72c5434d674bb89fe0e4972acebcf7
:ks_xref_id: facbb258a4cd4dd7bc15498c303298dd
:ks_comp: ../../../components/
:ks_title: 创建部署并注册为微服务
:ks_keywords: Kubernetes, {ks_product}, 项目管理, Spring Cloud, 创建部署并注册为微服务
:ks_description: 介绍如何创建部署并将部署注册为微服务。
:ks_weight: 01
:ks_icon:
...
== 前提条件link:[id=2362ecd35bca4b58a19a0f5dc7e2f672]
...
== 操作步骤link:[id=4c4f7280dc00437ead3bc187ba53538e]

请参阅link:#7387fd2ca5e042e8beb763e7aadb68b9[参数描述]设置部署的参数。
...
. 在**高级设置**页签，为部署管理的容器组指定 IP 池和节点，并设置部署的元数据，然后点击**创建**。
+
--
...
== 参数描述link:[id=7387fd2ca5e042e8beb763e7aadb68b9]
...
* 在已创建的标签右侧点击 image:/images/ks-qkcp/zh/icons/trash-light.svg[trash-light,18,18] 可删除标签。

|添加元数据
|设置部署的标签和注解。

* 点击添加可设置多条标签或注解。
* 在已创建的标签或注解右侧点击 image:/images/ks-qkcp/zh/icons/trash-light.svg[trash-light,18,18] 可删除标签或注解。
|===
--