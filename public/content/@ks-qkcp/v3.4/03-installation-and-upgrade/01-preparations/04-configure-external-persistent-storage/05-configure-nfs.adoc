...
// :ks_include_id: 3096b1a7d34a4437b6c65b2fc64f36a7
:ks_xref_id: 3479fe8e867a4b82b98efac74b55d313
:ks_comp: ../../../../components/
:ks_title: 配置 NFS
:ks_keywords: Kubernetes, {ks_product}, 安装, 准备, 持久化存储, 网络文件系统, NFS
:ks_description: 介绍如何在生产环境中为{ks_product_both}集群配置网络文件系统（NFS）。
:ks_weight: 05
:ks_icon:
...
== 搭建 NFS 服务端link:[id=aa233b62573b4ab3ba965a5f141b35c4]
...
=== 前提条件link:[id=42a89e4df5744cb2812a1810a0caa5dc]

您需要准备一台 Linux 服务器（以下以 Ubuntu 操作系统为例），该服务器必须与{ks_product_both}集群节点网络连通。


=== 操作步骤link:[id=513b45f935b24e9dad56e64211533c75]
...
== 配置{ks_product_both}集群节点link:[id=2a6295dcd5b04cc38a377f570db97f9b]
...
=== 前提条件link:[id=310db8c15f5749d29a1883c95391315c]

您需要搭建 NFS 服务端。有关更多信息，请参阅link:#aa233b62573b4ab3ba965a5f141b35c4[搭建 NFS 服务端]。


=== 操作步骤link:[id=d042e9381d46472bbb4239e2adfee7d7]
