...
// | kubefed                     | 联邦集群应用管理
// | whizard-monitoring          | WizTelemetry 监控
// | whizard-notification        | WizTelemetry 通知
// | whizard-alerting            | WizTelemetry 告警
// | whizard-events              | WizTelemetry 事件
// | whizard-auditing            | WizTelemetry 审计
// | whizard-logging             | WizTelemetry 日志
// | whizard-telemetry-ruler     | WizTelemetry 事件告警
// | whizard-telemetry           | WizTelemetry 平台服务
// | vector                      | WizTelemetry 数据流水线
// | grafana                       | Grafana for WizTelemetry
// | loki                         | Grafana Loki for WizTelemetry
// | alloy                         | Grafana Alloy for WizTelemetry
...
// | openpitrix                 | KubeSphere 应用商店管理
// | dmp                         | RadonDB DMP，云原生数据库管理平台
// | gateway                     | KubeSphere 网关
// | Ingress-utils                  | KubeSphere 应用路由工具
