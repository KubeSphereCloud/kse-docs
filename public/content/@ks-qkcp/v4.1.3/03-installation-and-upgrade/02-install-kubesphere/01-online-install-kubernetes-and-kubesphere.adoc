---
title: "在线安装 Kubernetes 和 KubeSphere 企业版"
...
本节介绍如何在可访问 Internet 的环境下安装 Kubernetes 和{ks_product_left}。
...
将 <Kubernetes version> 替换为实际需要的版本，例如 **v1.27.4**。{ks_product_right}默认支持 Kubernetes v1.21~1.30。
...
// 在线订阅版:
//         repo: https://charts.kubesphere.io/test（ 只有 nfs 是 repo: https://charts.kubesphere.io/main）
...
+
在使用{ks_product_both}及扩展组件之前，请先link:../03-activate-kse/[激活 KubeSphere 企业版和扩展组件]。
