...
description: "介绍如何使用 Grafana for WizTelemetry 扩展组件。"
weight: 16
---

本节介绍如何使用 Grafana for WizTelemetry 扩展组件。
...
安装 Grafana for WizTelemetry 扩展组件后，需修改扩展组件配置以暴露 Grafana 服务，才能访问 Grafana 控制台。
