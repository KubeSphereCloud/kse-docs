...
|
WizTelemetry 事件告警默认接收 Kubernetes 集群的日志。如果想要接收其他日志，需要修改 WizTelemetry 数据流水线的配置，或新建保密字典进行配置，请参阅 link:https://vector.dev/docs/reference/configuration/[Vector 官方文档]进行配置。
|===
...
* {ks_product_right}平台需要安装并启用 **WizTelemetry 事件告警**扩展组件。
