---
title: "WizTelemetry 事件告警"
keywords: "Kubernetes, {ks_product}, 事件, 审计, 告警"
description: "介绍如何使用“WizTelemetry 事件告警”扩展组件。"
weight: 09
---

本节介绍如何使用“WizTelemetry 事件告警”扩展组件。

WizTelemetry 事件告警支持审计告警、事件告警和日志告警功能。它支持为 Kubernetes/KubeSphere 审计事件、Kubernetes 原生事件、以及 Kubernetes 日志定义告警规则，对传入的事件数据和日志数据进行评估，并将告警发送到指定的接收器如 HTTP 端点等。
