...
// . 在应用详情页面点击**灰度发布**查看应用的灰度发布信息。有关更多信息，请参阅link:../../02-grayscale-release/[灰度发布]。
// +
// --
// // Note
