...
description: "介绍如何管理应用、自制应用和应用仓库。"
weight: 09
layout: "second"
---


本节介绍如何管理应用、自制应用和应用仓库。

在 KubeSphere 平台，应用特指由一个或多个工作负载、服务、应用路由等资源组成的业务程序。KubeSphere 平台的应用模板和应用仓库功能底层基于 Helm 实现，通过 Helm Chart 定义应用的编排方式。
