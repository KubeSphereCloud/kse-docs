...
若要使用代理连接， KubeSphere 平台需要安装并启用 **KubeSphere 多集群代理连接**扩展组件。有关更多信息，请参阅link:../../../../11-use-extensions/19-tower/02-add-a-member-cluster-using-proxy-connection/[通过代理连接添加成员集群]。
endif::[]

ifeval::["{file_output_type}" == "pdf"]
若要使用代理连接， KubeSphere 平台需要安装并启用 **KubeSphere 多集群代理连接**扩展组件。有关更多信息，请参阅《KubeSphere 扩展组件使用指南》的“KubeSphere 多集群代理连接”章节。
endif::[]
|===
