...
* link:../../08-workspace-management/11-service-and-network/05-routes/01-create-a-route/[创建应用路由]。示例应用 bookinfo 已自动创建应用路由。
