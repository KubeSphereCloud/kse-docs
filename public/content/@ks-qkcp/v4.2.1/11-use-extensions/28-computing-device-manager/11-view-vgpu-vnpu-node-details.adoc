---
title: "查看 vGPU/vNPU 节点详情"
keywords: "Kubernetes, {ks_product}, 集群管理, 算力节点, 查看 vGPU/vNPU 节点详情"
description: "介绍如何查看 vGPU/vNPU 节点详情。"
weight: 11
---
...
. 在**运行状态**页签查看节点的资源用量、显卡信息、已分配资源、健康状态和污点。
+
--
[%header,cols="1a,4a"]
|===
