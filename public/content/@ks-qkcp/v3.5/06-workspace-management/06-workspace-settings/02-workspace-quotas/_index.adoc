...
// :ks_include_id: e54abf0f339745378ab4af131a081148
:ks_xref_id: 5749e95e116249ff875c3d71aaacac4b
:ks_comp: ../../../../components/
:ks_title: 企业空间配额
:ks_keywords: Kubernetes, {ks_product}, 企业空间, 企业空间设置, 企业空间配额
:ks_description: 介绍如何查看和管理企业空间配额。
:ks_weight: 02
:ks_icon:
...
在{ks_product_both}平台，多个集群可以授权给同一个企业空间，您可以在企业空间设置中针对每个集群设置资源配额。企业空间配额包括两类设置：
