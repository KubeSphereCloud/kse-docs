---
title: "创建有状态或无状态服务"
keywords: "Kubernetes, {ks_product}, 多集群项目, 工作负载, 服务, 创建服务, 创建有状态或无状态服务"
description: "介绍如何创建有状态或无状态服务。"
weight: 01
---

// :ks_include_id: bc573c12d0a548db846f712add91aff5
:ks_xref_id: 164cff91c61a4b239ba5dedd43fabede
:ks_comp: ../../../../components/
:ks_title: 创建有状态或无状态服务
:ks_keywords: Kubernetes, {ks_product}, 多集群项目, 工作负载, 服务, 创建服务, 创建有状态或无状态服务
:ks_description: 介绍如何创建有状态或无状态服务。
:ks_weight: 01
:ks_icon:
...
本节介绍如何在多集群项目中创建有状态或无状态服务。


== 前提条件link:[id=2605294c063747ce8633045968e9b4b9]

include::../../../../_custom/multi-clusterProjectManagement/projectManagement-prer-requiredPermission.adoc[]


== 操作步骤link:[id=7e4981cde69d498fa754008fdfd6a356]

请参阅link:#9bbb62bf11894d2bbe8d0fecc92e2a3a[参数描述]设置服务的参数。
...
== 参数描述link:[id=9bbb62bf11894d2bbe8d0fecc92e2a3a]
