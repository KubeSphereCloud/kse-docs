---
title: "使用源代码创建服务"
keywords: "Kubernetes, {ks_product}, 项目管理, 工作负载, 服务, 创建服务, 通过源代码创建服务"
description: "介绍如何创建服务并使用源代码创建服务后端的工作负载。"
weight: 03
---

// :ks_include_id: 89d769f2a40342479f67fe6461951f27
:ks_xref_id: 96dfc17782a44df596b8454beb7d8a6a
:ks_comp: ../../../../../components/
:ks_title: 使用源代码创建服务
:ks_keywords: Kubernetes, {ks_product}, 项目管理, 工作负载, 服务, 创建服务, 通过源代码创建服务
:ks_description: 介绍如何创建服务并使用源代码创建服务后端的工作负载。
:ks_weight: 03
:ks_icon:
...
== 前提条件link:[id=e5e170a1ff6f47f98fb0abdc963800a5]
...
include::../../../../../_custom/projectManagement/services/services-prer-sourceCodeRepository.adoc[]
...
== 操作步骤link:[id=07908e4654bd4d9a998513c4aa8411eb]

请参阅link:../01-create-a-stateful-or-stateless-service/#71c68177415d4fea91cacf8073f91d1f[参数描述]设置服务的参数。
...
. 在**创建服务**对话框，根据源代码的语言选择 **Java**、**Node.js** 或 **Python**。
...
. 在**构建设置**页签，设置服务类型、构建环境、代码仓库信息和镜像服务信息，然后点击**下一步**。
...
== 参数描述link:[id=5ae8ae3d322046fdadfa24db1c09f3de]

以下介绍如何设置通过源代码创建服务的参数。
