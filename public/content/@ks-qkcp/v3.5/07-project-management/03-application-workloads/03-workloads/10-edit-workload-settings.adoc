---
title: "编辑工作负载设置"
keywords: "Kubernetes, {ks_product}, 项目管理, 应用负载, 工作负载, 编辑工作负载设置"
description: "介绍如何编辑工作负载设置。"
weight: 10
---

// :ks_include_id: 21c70e8861d4428c8eb415eab4445847
:ks_xref_id: d8c0cbe896f74ff697169106bb166b41
:ks_comp: ../../../../components/
:ks_title: 编辑工作负载设置
:ks_keywords: Kubernetes, {ks_product}, 项目管理, 应用负载, 工作负载, 编辑工作负载设置
...
== 前提条件link:[id=825062a515d545d3a1f7f0411e9db6ba]
...
== 操作步骤link:[id=3c1d9929e7b749dea01f42c0a10b1fa6]
...
. 在**编辑设置**对话框，分别设置工作负载的更新策略、容器、卷和容器组调度规则（仅对部署可用），然后点击**确定**。有关具体的参数设置方法，请参阅link:#fddcc52d437e49cf8d372b5be811a9ad[参数描述]。

== 参数描述link:[id=fddcc52d437e49cf8d372b5be811a9ad]
