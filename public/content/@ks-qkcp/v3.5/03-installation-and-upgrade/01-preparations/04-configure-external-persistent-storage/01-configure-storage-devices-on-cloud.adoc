...
// :ks_include_id: c6d0235184514a6fba9f67b98820b56d
:ks_xref_id: db935d5299b64a8e9561e108985ea1b4
:ks_comp: ../../../../components/
:ks_title: 配置云上存储设备
:ks_keywords: Kubernetes, {ks_product}, 安装, 准备, 持久化存储, 云上存储设备
:ks_description: 介绍如何在生产环境中为{ks_product_both}集群配置云上存储设备。
:ks_weight: 01
:ks_icon:
