...
// :ks_include_id: f25e18faca1b48cc98f9dafaefd5d4c1
:ks_xref_id: 6e2f57553cd84468b19750851f220ae2
:ks_comp: ../../../../components/
:ks_title: 配置 NeonSAN CSI
:ks_keywords: Kubernetes, {ks_product}, 安装, 准备, 持久化存储, 网络文件系统, NeonSAN CSI
:ks_description: 介绍如何在生产环境中为{ks_product_both}集群配置 NeonSAN CSI。
:ks_weight: 04
:ks_icon:
...
== 前提条件link:[id=de40448acdee4f1abaad6b8ff6be43fa]
...
== 操作步骤link:[id=d74182e9b456496bb9e68b3e31352846]


=== 在线安装 NeonSAN CSIlink:[id=db2f7d5a7dc74809bf0fcf172956986f]
...
=== 离线安装 NeonSAN CSIlink:[id=c4903c7852be44c492281072c4cdb0cb]
...
. 参考link:#db2f7d5a7dc74809bf0fcf172956986f[在线安装]中步骤 8 - 12 执行安装后检查。
+
--
NeonSAN CSI 安装成功后，您可以在 KubeSphere 企业版控制台上的**存储**区域查看。有关更多信息，请参阅《{ks_product_right}集群管理指南》。
--