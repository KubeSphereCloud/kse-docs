---
title: "查看存储类列表"
keywords: "Kubernetes, {ks_product}, 集群管理, 存储, 存储类, 查看存储类列表"
description: "介绍如何查看存储类列表。"
weight: 02
---

// :ks_include_id: 0fff4f86ba264c718605d9a2ff6c4995
:ks_xref_id: 7892008a32d04e83a7a6deb3d51c409a
:ks_comp: ../../../../components/
:ks_title: 查看存储类列表
:ks_keywords: Kubernetes, {ks_product}, 集群管理, 存储, 存储类, 查看存储类列表
:ks_description: 介绍如何查看存储类列表。
:ks_weight: 02
:ks_icon:
:ks_permission: **存储类查看**
...
== 前提条件link:[id=097191112c9d4ded8fa2074bb002db4d]
...
== 操作步骤link:[id=b9b4b0323eff4a30b23903be92fddaf7]
