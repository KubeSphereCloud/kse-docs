...
// :ks_include_id: e1cbc31b690f4b77b02fcdf9b4f24aee
:ks_xref_id: 3958f6637976499e83da99fa0d218112
:ks_comp: ../../../../components/
:ks_title: 查看存储类详情
:ks_keywords: Kubernetes, {ks_product}, 集群管理, 存储, 存储类, 查看存储类详情
:ks_description: 介绍如何查看存储类详情。
:ks_weight: 03
:ks_icon:
:ks_permission: **存储类查看**
...
== 前提条件link:[id=6991db2222c344adb616887f76f0ac36]
...
== 操作步骤link:[id=0d87ec3dfbff48eaa6ef38bb21d0172b]
