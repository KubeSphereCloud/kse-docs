...
// :ks_include_id: 35418816584b46029f5df779cdd7d320
:ks_xref_id: 33178828f4ae4c73aecae5e3aff8f51f
:ks_comp: ../../../../components/
:ks_title: 查看 etcd 数据库状态
:ks_keywords: Kubernetes, {ks_product}, 监控告警, 集群状态，etcd 状态
:ks_description: 介绍如何查看 etcd 数据库状态。
:ks_weight: 03
:ks_icon:
...
== 前提条件link:[id=19faacceb4414168854c074badbf3280]
...
== 操作步骤link:[id=db4abfc05b6b42bc8264ab805d8ee906]
...
. 在**集群状态**页面，点击 **etcd 状态**页签查看 etcd 数据库的运行状态。
+
====
* **etcd 状态**页签提供以下信息：
+
...
有关 etcd 数据库参数的更多信息，请参阅link:https://etcd.io/docs/v3.3/metrics/[etcd 官方文档]。
--
