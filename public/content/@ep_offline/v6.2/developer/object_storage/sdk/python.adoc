...
对象存储的新版 Python SDK，已在 GitHub 开源。本文为简要使用文档，更多详细信息请参见 https://github.com/qingstor/qingstor-sdk-python[GitHub 项目]
和 https://qingstor-sdk-python.readthedocs.io/en/latest/[Python SDK API 文档]。

Python SDK 使用 https://github.com/yunify/snips[Snips] 工具生成，各接口的调用均与对象存储的 API 相对应。其返回码、请求头、错误码等规定请参照具体的 link:../../api/overview/[API 文档]。
...
具体配置，可参考link:https://github.com/qingstor/qingstor-sdk-python/blob/master/docs/config_zh-CN.md[ Github 上的配置说明]，其中 Access Key，需根据云平台的 Console 上申请的 API 密钥进行填写。
