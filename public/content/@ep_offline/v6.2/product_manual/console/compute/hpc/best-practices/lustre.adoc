...
使用高性能计算集群进行深度学习等需要高速的数据传输能力的作业时，需要将集群的文件存储与 GPU 云服务器之间建立 IB 网络，可参考如下步骤进行。
...
* 10.103.100.93@o2ib:10.103.100.94@o2ib:/es01 为固定的 lustre 信息，无需修改。
* /mnt/data_lustre 为挂载点名称，需根据实际情况进行修改。
* 登录主机可参考link:../../../vm/quickstart/login_vm/[云服务器]相关内容。
