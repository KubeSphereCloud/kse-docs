...
qsftpd 支持 Linux、MacOS 和 Windows 操作系统，可访问 GitHub 项目的 link:https://github.com/yunify/qsftpd/releases[Releases] 页面查看和下载历史版本。Windows 最新版本下载链接：link:https://pek3a.qingstor.com/releases-qs/qsftpd/qsftpd-latest-windows_amd64.tar.gz[qsftpd-latest-windows_amd64]

== 使用示例

=== 下载并解压 tar 包

下载链接：link:https://pek3a.qingstor.com/releases-qs/qsftpd/qsftpd-latest-windows_amd64.tar.gz[下载]
