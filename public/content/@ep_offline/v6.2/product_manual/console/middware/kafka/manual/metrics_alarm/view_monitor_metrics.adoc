...
keywords: 云计算,大数据,消息队列,中间件,Kafka 监控指标,Kafka,资源监控,服务监控
weight: 40
collapsible: false
draft: false
---
...
提供的云监控 CloudSat，可对 Kafka 的运行状态进行日常监控。您可以通过 CloudSat  {platform_name}，一站式监控和告警 Kafka 各类服务、资源指标。
...
+
image::/images/cloud_service/middware/kafka/manual_node_monitor.png[节点监控]
...
*实时监控为开启时*
+
image::/images/cloud_service/middware/kafka/manual_service_monitor_realtime.png[]
...
*实时监控为开启时*
+
image::/images/cloud_service/middware/kafka/manual_resource_monitor_realtime.png[]
