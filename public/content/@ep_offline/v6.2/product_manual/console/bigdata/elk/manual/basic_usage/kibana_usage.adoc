...
如果显示 "Unable to fetch mapping. Do you have indices matching the pattern?"，可参考 link:../logstash_usage[Logstash 基本用法] 发送一些数据。

include::../../../../../../../../_components/table_footer.adoc[]

image::/images/cloud_service/bigdata/elk/kibana_elk.png[config_index]

index pattern 创建成功后可点击左侧栏的 `Discover` 菜单查看导入的日志。

include::../../../../../../../../_components/note.adoc[]

关于 Kibana 更多的使用方式，请参考link:https://www.elastic.co/guide/en/kibana/6.7/index.html[官方文档]。
