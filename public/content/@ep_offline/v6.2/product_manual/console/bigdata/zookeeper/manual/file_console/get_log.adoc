---
title: "查看日志及数据文件"
description: 通过文件 {platform_name}查看日志及数据文件。
...
* link:../enable/#_开启文件 {platform_name}[开启文件 {platform_name}]。
...
+
image::/images/cloud_service/bigdata/zookeeper/file_console.png[文件 {platform_name}]

. 输入文件 {platform_name}用户名和密码。
. 点击对应路径，即可查看相应的日志文件。
+
