...
在 AppCenter 集群 {platform_name}，支持对 ZooKeeper 常用配置参数的管理。更多相关配置参数的说明和用法，可参考 link:https://zookeeper.apache.org/doc/r3.4.13/zookeeperAdmin.html#sc_configuration[ZooKeeper 官方文档]。
