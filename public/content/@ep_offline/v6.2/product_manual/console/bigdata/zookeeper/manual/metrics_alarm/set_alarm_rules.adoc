...
* 支持<<_绑定指标告警策略,绑定指标告警策略>>，自定义告警规则和监控项，及时监控 ZooKeeper 各项指标状态。
...
+
image::/images/cloud_service/bigdata/zookeeper/alarm.png[告警]
...
+
image::/images/cloud_service/bigdata/zookeeper/manual_new_alarm_policy.png[配置指标告警策略]

. 返回**告警**页签，选中已绑定指标告警策略节点，可查看配置的指标和告警历史。
+
image::/images/cloud_service/bigdata/zookeeper/check_alarm.png[查看通知策略]
...
+
image::/images/cloud_service/bigdata/zookeeper/manual_set_alarm_basic.png[配置告警行为]
. 点击**下一步**，配置告警规则。
+
...
include::../../../../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/bigdata/zookeeper/manual_set_alarm_rule.png[配置告警行为]
...
+
image::/images/cloud_service/bigdata/zookeeper/manual_set_alarm_behavior.png[配置告警行为]
...
include::../../../../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/bigdata/zookeeper/manual_new_alarm_policy.png[配置新告警策略]
...
+
image::/images/cloud_service/bigdata/zookeeper/single_notice.png[配置通知策略]

. 返回**告警**页签，查看配置的统一通知策略。
+
image::/images/cloud_service/bigdata/zookeeper/check_notice.png[查看通知策略]
