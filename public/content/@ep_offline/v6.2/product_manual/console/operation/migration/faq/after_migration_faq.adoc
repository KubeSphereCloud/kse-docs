...
若硬盘控制器类型设置为 vd：virtio 和 sd：scsi，需额外驱动支持，详细操作请参考[更新 virtio 驱动]。

//link:/v6.1/operation/migration/manual/check_server/#_更新_virtio_驱动[更新 virtio 驱动]。
