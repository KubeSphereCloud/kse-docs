...
keywords: MongoDB Cluster 修改账号；
weight: 15
collapsible: false
draft: false
---
在 AppCenter 集群 {platform_name}，支持修改 MongoDB Cluster 集群的配置参数。
...
+
image::/images/cloud_service/database/mongodb_cluster/modify_para.png[修改配置参数]
