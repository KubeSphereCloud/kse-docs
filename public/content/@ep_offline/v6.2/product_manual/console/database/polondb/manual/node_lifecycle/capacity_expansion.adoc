...
. 展开下拉菜单，点击**扩容集群**。
+
image::/images/cloud_service/database/polondb/expansion.png[创建扩容]
...
. 点击**创建**，弹出策略基本信息配置窗口。
+
image::/images/cloud_service/database/polondb/auto_expansion.png[自动伸缩策略]
...
+
image::/images/cloud_service/database/polondb/auto_expansion_rules.png[自动伸缩规则]
