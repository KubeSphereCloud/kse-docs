...
keywords: mongodump,mongorestore,数据导入,数据导出 
weight: 30
collapsible: false
draft: false
---
MongoDB 支持使用 https://docs.mongodb.com/manual/reference/program/mongodump/[mongodump] 和 https://docs.mongodb.com/manual/reference/program/mongorestore/[mongorestore] 工具，实现 MongoDB 数据迁移。
