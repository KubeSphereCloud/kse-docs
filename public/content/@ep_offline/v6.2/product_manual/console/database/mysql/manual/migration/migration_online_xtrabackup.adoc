...
keywords: 数据库,MySQL PLus,关系型数据库,MySQL,xtrabackup 方式在线迁移
weight: 20
collapsible: false
draft: false
---
...
. 启动在线迁移。
 ...
 .. 展开下拉菜单，点击**在线迁移**。
+
image::/images/cloud_service/database/mysql/migration_online2.png[在线迁移,50%]
