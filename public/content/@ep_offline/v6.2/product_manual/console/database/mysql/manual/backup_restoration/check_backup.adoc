...
keywords: 数据库,MySQL PLus,关系型数据库,MySQL,数据逻辑备份策略
weight: 30
collapsible: false
draft: false
---
...
+
image::/images/cloud_service/database/mysql/backup_list.png[备份列表]
...
+
image::/images/cloud_service/database/mysql/check_backup_1.png[快照备份]
+
image::/images/cloud_service/database/mysql/check_backup_2.png[逻辑备份]
