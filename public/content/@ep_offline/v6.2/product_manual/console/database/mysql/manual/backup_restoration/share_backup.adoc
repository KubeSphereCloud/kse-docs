...
keywords: 数据库,MySQL PLus,关系型数据库,MySQL,共享备份,
weight: 80
collapsible: false
draft: false
---
...
+
image::/images/cloud_service/database/mysql/share_backup_1.png[共享备份]

. 点击**共享备份**，弹出共享配置窗口。
+
image::/images/cloud_service/database/mysql/share_backup_2.png[共享备份]
...
+
image::/images/cloud_service/database/mysql/share_backup_3.png[共享备份]
