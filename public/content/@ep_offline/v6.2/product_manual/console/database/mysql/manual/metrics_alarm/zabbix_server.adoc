...
. 下载 link:https://releases-qs.pek3a.qingstor.com/zabbix/zbx_export_templates.xml?response-content-disposition=attachment[Percona Zabbix Templates] 模板。
...
. 登录 Appcenter  {platform_name}，在 MySQL PLus 集群节点页面，查看并记录 MySQL PLus 节点的 IP 信息。 +
