...
云监控 CloudSat，可对 ClickHouse 的运行状态进行日常监控。您可以通过 CloudSat  {platform_name}，一站式监控和告警 ClickHouse 各类服务、资源指标。您可以在 ClickHouse 集群详情页面，查看主实例监控和查看备实例监控。
...
+
image::/images/cloud_service/dwh_bi/clickhouse/manual_node_monitor.png[节点监控]
...
*实时监控为关闭时*
+
image::/images/cloud_service/dwh_bi/clickhouse/manual_service_monitor.png[]
+
*实时监控为开启时*
+
image::/images/cloud_service/dwh_bi/clickhouse/manual_service_monitor_realtime.png[]
