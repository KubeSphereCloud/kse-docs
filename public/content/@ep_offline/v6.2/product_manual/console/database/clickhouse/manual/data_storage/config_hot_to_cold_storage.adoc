...
keywords: TTL 存储策略,TTL,冷热存储策略,数据仓库,ClickHouse
weight: 20
collapsible: false
draft: false
---
...
更多 TTL 语句说明，请参见link:https://clickhouse.com/docs/zh/engines/table-engines/mergetree-family/mergetree/?spm=a2c4g.11186623.0.0.39c34190hHLmew#table_engine-mergetree-ttl[TTL]。
