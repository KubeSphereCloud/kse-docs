...
keywords: 扩容节点,扩容资源配置,扩内存,扩磁盘大小,键值数据库,Redis,Redis Standalone,数据库
weight: 06
collapsible: false
draft: false
---
...
+
image::/images/cloud_service/database/redis_standalone/expansion_6.png[创建扩容,50%]
+
**5.x 版本**扩容需配置节点云服务器 CPU 规格、内存规格和磁盘大小。
+
image::/images/cloud_service/database/redis_standalone/expansion_5.png[创建扩容,50%]
