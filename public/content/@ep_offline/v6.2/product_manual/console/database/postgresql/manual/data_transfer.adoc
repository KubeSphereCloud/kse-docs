...
image::/images/cloud_service/database/postgresql/pg_datadump.png[数据导出]
...
----
+
image::/images/cloud_service/database/postgresql/pg_dataimport.png[数据导入]
...
image::/images/cloud_service/database/postgresql/pg_importdataonline.png[数据导入]
...
image::/images/cloud_service/database/postgresql/datacheck.png[数据check]
