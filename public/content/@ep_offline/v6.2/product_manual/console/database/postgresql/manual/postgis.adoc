...
keywords: PostgreSQL 插件,PostGIS 插件,PostgreSQL,关系型数据库,数据库
weight: 45
collapsible: false
---
...
----
+
image::/images/cloud_service/database/postgresql/checkpostgis.png[]
...
----
+
image::/images/cloud_service/database/postgresql/postgis_full_version.png[]
