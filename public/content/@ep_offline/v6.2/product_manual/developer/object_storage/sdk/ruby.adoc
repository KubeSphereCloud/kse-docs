...
对象存储的 Ruby SDK 已在 GitHub 开源，本文为简要使用文档。更多详细信息请参见 https://github.com/qingstor/qingstor-sdk-ruby[GitHub 项目]。
...
具体配置，可参考link:https://github.com/qingstor/qingstor-sdk-ruby/blob/master/README.md#more-configuration[ Github 上的配置说明]，其中 Access Key，需根据云平台的 Console 上申请的 API 密钥进行填写。
