...
keywords: TTL 存储规则，TTL，冷热存储策略,时序数据库,ChronusDB,数据库 
weight: 20
collapsible: false
draft: false
---
...
更多 TTL 语句说明，请参见 https://clickhouse.com/docs/zh/engines/table-engines/mergetree-family/mergetree/?spm=a2c4g.11186623.0.0.39c34190hHLmew#table_engine-mergetree-ttl[TTL]。

include::../../../../../../../../_components/table_footer.adoc[]


以下示例简表语句，以 date 为时间列，在 ``ossp_hot_to_cold`` 策略上，将 180 之前所有数据转移到 `ossp` 冷数据盘。
