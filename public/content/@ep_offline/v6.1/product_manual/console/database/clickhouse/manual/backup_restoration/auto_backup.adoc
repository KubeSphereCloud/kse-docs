...
keywords: 数据自动备份,ClickHouse
weight: 20
collapsible: false
draft: false
---
为确保集群数据的全量备份，在 AppCenter 集群 {platform_name}，ClickHouse 提供数据自动备份管理，通过设置自动备份时间，启动定时数据备份。
...
+
image::/images/cloud_service/dwh_bi/clickhouse/backup_auto.png[自动备份]
