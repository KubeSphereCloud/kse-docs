...
. 展开下拉菜单，点击**开启数据迁移**。
+
image::/images/cloud_service/dwh_bi/clickhouse/mir_1.png[开启数据迁移]

. 在**运行开启数据迁移服务**弹出框填写参数。
+
image::/images/cloud_service/dwh_bi/clickhouse/mir_2.png[开启数据迁移]
+
 ...
 ** Full：正在进行全量迁移。
+
image::/images/cloud_service/dwh_bi/clickhouse/mir_full.png[full]

 ** Increment：设置了增量迁移且当前迁移已完成，等待下一次增量迁移。
+
image::/images/cloud_service/dwh_bi/clickhouse/mir_increment.png[increment]

 ** Incrementing：正在进行增量迁移。
+
image::/images/cloud_service/dwh_bi/clickhouse/mir_incrementing.png[incrementing]
