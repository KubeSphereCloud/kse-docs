...
若安装 Prometheus 和 Grafana 的服务器与 ClickHouse 之间网络不通，可通过link:../../../../../network/border_router/[边界路由器]或 link:../../../../../network/vpc/manual/vpn/[VPN] 等方式打通网络。不建议通过**端口转发**的方式将服务暴露到公网，以免造成 ClickHouse 关键信息暴露等风险。
