...
keywords: BGREWRITEAOF,BGSAVE,CONFIG,SAVE,DEBUG,KEYS,REPLICAOF,SHUTDOWN,SLAVEOF,禁用命令,被禁用的命令
weight: 10
collapsible: false
draft: false
---
...
+
image::/images/cloud_service/database/redis_standalone/cmd_para.png[被禁用命令]
