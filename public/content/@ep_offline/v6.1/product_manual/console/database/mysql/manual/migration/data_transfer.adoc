...
keywords: 数据库,MySQL PLus,关系型数据库,MySQL,离线数据迁移,
weight: 30
collapsible: false
draft: false
---
...
也可选择导出数据库部分数据，详细命令说明请参考 https://dev.mysql.com/doc/refman/5.7/en/mysqldump.html[mysqldump]。
...
. 校验当前集群与远端数据库数据是否一致。
. 将业务连接地址修改为当前集群的**高可用 IP**，则业务迁移完毕。
