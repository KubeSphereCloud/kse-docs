...
draft: false
---
通过 AppCenter 集群 {platform_name}，您可以快速创建 Redis 集群。本小节主要介绍如何快速创建 Redis 集群。

== 前提条件

已注册{product_name}账号并完成实名认证。
...
阅读《{product_name} AppCenter 用户协议》并勾选确认接受该协议，点击**提交**，若开始创建 Redis 集群。
