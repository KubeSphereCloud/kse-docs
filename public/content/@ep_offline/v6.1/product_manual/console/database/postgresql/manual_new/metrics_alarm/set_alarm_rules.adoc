...
* 支持<<_绑定指标告警策略,绑定指标告警策略>>，自定义告警规则和监控项，及时监控 PostgreSQL 各项指标状态。
 ** 可自定义告警项，详情可参见<<_告警项说明>>。
 ** 可自定义告警监控周期：`1分钟`、`5分钟`
...
+
image::/images/cloud_service/database/postgresql/metrics_alarm.png[配置指标告警策略,70%]
...
+
image::/images/cloud_service/database/postgresql/manual_set_alarm_basic.png[配置告警行为,70%]
...
include::../../../../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/database/postgresql/manual_set_alarm_rule.png[配置告警行为,70%]
 ...
 *通知列表* ：选择告警通知列表。
+
image::/images/cloud_service/database/postgresql/manual_set_alarm_behavior.png[配置告警行为,70%]
...
+
image::/images/cloud_service/database/postgresql/single_notice.png[配置通知策略,70%]
