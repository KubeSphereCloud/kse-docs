...
. 展开下拉菜单，点击**扩容集群**。
+
image::/images/cloud_service/database/postgresql/expansion1.png[创建扩容]

. 配置扩容信息。
+
勾选需扩容节点角色，并分别配置节点规格和磁盘大小。
...
. 点击**创建**，弹出策略基本信息配置窗口。
+
image::/images/cloud_service/database/postgresql/auto_expansion.png[自动伸缩策略,60%]
