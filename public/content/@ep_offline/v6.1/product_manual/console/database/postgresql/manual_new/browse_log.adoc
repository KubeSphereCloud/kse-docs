...
+
image::/images/cloud_service/database/postgresql/confi_log_para.png[]
. 点击**日志**页签，可查看对应的日志列表。
+
image::/images/cloud_service/database/postgresql/view_log.png[]
+
您也可以连接 PostgreSQL 数据库在线查看数据的日志，同时可以借助 sql 的能力进行日志的分析。
+
image::/images/cloud_service/database/postgresql/view_log_1.png[]
