...
keywords: 查看备份,备份详情,MongoDB,文档数据库,数据库
weight: 30
collapsible: false
draft: false
---
在 AppCenter 集群 {platform_name}，MongoDB 支持查看和管理备份列表。
...
+
image::/images/cloud_service/database/mongodb/check_backup_1.png[备份详情]
