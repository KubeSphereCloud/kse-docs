...
+
image::/images/cloud_service/database/mongodb/mtools_log_01.png[查看日志基本信息]
...
显示如下类似信息。
+
image::/images/cloud_service/database/mongodb/mtools_log_02.png[查看连接数]
...
显示如下类似信息。
+
image::/images/cloud_service/database/mongodb/mtools_log_03.png[查看连接数]
...
显示如下类似信息。
+
image::/images/cloud_service/database/mongodb/mtools_log_04.png[查看连接数]
...
显示如下类似信息。
+
image::/images/cloud_service/database/mongodb/mtools_log_05.png[查看连接数]
...
显示如下类似信息。
+
image::/images/cloud_service/database/mongodb/mtools_log_06.png[查看连接数]
