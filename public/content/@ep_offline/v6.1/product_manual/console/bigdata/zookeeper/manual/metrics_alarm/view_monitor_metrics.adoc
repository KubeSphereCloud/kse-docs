...
AppCenter 监控扫描周期默认为 5 分钟，新增节点暂无法查看监控信息。
...
+
image::/images/cloud_service/bigdata/zookeeper/manual_node_monitor.png[节点监控]
...
*实时监控为关闭时*
+
image::/images/cloud_service/bigdata/zookeeper/manual_resource_monitor.png[]
+
*实时监控为开启时*
+
image::/images/cloud_service/bigdata/zookeeper/manual_resource_monitor_realtime.png[]
