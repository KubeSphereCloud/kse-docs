...
keywords: 搜索分析,Logstash-input-syslog,插件使用说明
weight: 55
collapsible: false
draft: false
---
...
更多的预置 Logstash 插件请参见 link:../logstash_plugin_list[Logstash 预置插件列表]。
...
请根据具体配置替换上面的配置，其他配置参数详情请参见link:https://www.elastic.co/guide/en/logstash/6.7/plugins-inputs-syslog.html[官方文档]。
