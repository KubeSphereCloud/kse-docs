...
+
image::/images/cloud_service/bigdata/opensearch/faq_quota.png[,60%]

* 当 user1-xxx 索引的主分片占用磁盘空间达到 40G 时，发出通知。
+
image::/images/cloud_service/bigdata/opensearch/faq_quota01.png[,60%]
