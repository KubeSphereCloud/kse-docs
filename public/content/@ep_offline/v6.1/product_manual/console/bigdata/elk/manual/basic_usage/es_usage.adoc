...
keywords: Elasticsearch 基本用法,ELK
weight: 10
collapsible: false
draft: false
---
...
* Elasticsearch 从 6.x 版本起，新创建的 index 不再支持多 mapping types（在老版本创建的可以在 6.x 版本继续使用），官方建议使用 `_doc` 作为唯一的 mapping type。更多详情请查阅 https://www.elastic.co/guide/en/elasticsearch/reference/6.7/removal-of-types.html[官方说明]。
