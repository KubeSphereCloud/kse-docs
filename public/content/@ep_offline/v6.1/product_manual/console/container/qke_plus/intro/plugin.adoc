...
.2+|存储插件 |csi-qingcloud-controller | https://github.com/yunify/qingcloud-csi[csi-qingcloud-controller] 是{product_name}存储插件，自动集成于 {k8s_engine_shortname} 中。
...
|{product_name}插件 |cloud-controller-manager | https://github.com/yunify/qingcloud-cloud-controller-manager[cloud-controller-manager] 是一款负载均衡器插件，自动集成于 {k8s_engine_shortname} 中。
