...
keywords: 云计算,消息队列,中间件,RabbitMQ,监控告警
weight: 20
collapsible: false
draft: false
---
...
* 支持<<_绑定指标告警策略,绑定指标告警策略>>，自定义告警规则和监控项，及时监控 RabbitMQ 各项指标状态。
...
+
image::/images/cloud_service/middware/rabbitmq/bind_metrics_strategy.png[绑定指标告警策略]
...
+
image::/images/cloud_service/middware/rabbitmq/metrics_alarm.png[配置指标告警策略,70%]
...
+
image::/images/cloud_service/middware/rabbitmq/manual_set_alarm_basic.png[配置告警行为,70%]
. 点击**下一步**，配置告警规则。
+
...
include::../../../../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/middware/rabbitmq/manual_set_alarm_rule.png[配置告警规则,70%]
...
+
image::/images/cloud_service/middware/rabbitmq/manual_set_alarm_behavior.png[配置告警行为,70%]
...
include::../../../../../../../../_components/table_footer.adoc[]
+
image::/images/cloud_service/middware/rabbitmq/manual_new_alarm_policy.png[配置新告警策略,70%]
...
+
image::/images/cloud_service/middware/rabbitmq/alarm.png[告警]

. 在弹出的通知策略配置窗口，选择通知策略，并点击**提交**。
+
image::/images/cloud_service/middware/rabbitmq/single_notice.png[配置通知策略,70%]

. 返回**告警**页签，查看配置的独立通知策略。
+
image::/images/cloud_service/middware/rabbitmq/check_notice.png[查看通知策略]
