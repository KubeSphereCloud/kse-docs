...
QingStor 对象存储的 C/C++ SDK 已在 GitHub 开源，本文为简要使用文档。更多详细信息请参见 link:https://github.com/yunify/qingstor-sdk-cpp[GitHub 项目]。

本 SDK 使用 link:https://github.com/yunify/snips[Snips] 工具生成，各接口的调用均与 QingStor 对象存储的 API 相对应。其返回码、请求头、错误码等规定请参照具体的 link:../../api/[Qingstor API 文档]。
