...
+
image::/images/cloud_service/database/redis_cluster/redisshake_01.png[基本设置]

=== 第2步：节点设置

选择主机类型、CPU和内存规格。主机类型推荐选择``企业型 e3``，实际请根据集群情况选择规格。

image::/images/cloud_service/database/redis_cluster/redisshake_02.png[节点设置]
...
image::/images/cloud_service/database/redis_cluster/redisshake_03.png[网络设置]
...
+
image::/images/cloud_service/database/redis_cluster/redisshake_04.png[填写参数]
...
image::/images/cloud_service/database/redis_cluster/redisshake_05.png[查看]
...
| big_key_threshold
| -
| 如果目的端大版本小于源端, 也建议设置为1。默认值为524288000。
