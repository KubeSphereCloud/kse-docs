...
keywords: 常见报错,数据仓库,ClickHouse,数据库
weight: 05
draft: false
---
...
调整 `max_partitions_per_insert_block` 参数值大小。ClickHouse 支持在线修改 `max_partitions_per_insert_block` 参数值，请参见link:../../manual/config_para/check_para[修改配置参数]。
