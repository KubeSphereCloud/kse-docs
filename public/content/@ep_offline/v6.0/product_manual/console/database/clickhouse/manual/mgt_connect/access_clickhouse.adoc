...
keywords: ClickHouse 实例,访问集群,数据仓库,ClickHouse
weight: 10
collapsible: false
draft: false
---
...
更多使用信息可以参考link:https://clickhouse.yandex/docs/en/[ClickHouse]。
...
. 在**节点**页签，可获取各节点 IP。
+
image::/images/cloud_service/dwh_bi/clickhouse/check_node.png[节点 IP]
