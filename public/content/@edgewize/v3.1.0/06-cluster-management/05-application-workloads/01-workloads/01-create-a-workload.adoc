...
+
--
include::../../../../_custom/clusterManagement/workloads/createWorkload/workloads-para-updatePolicy_deploy.adoc[]
--

* 容器组设置 > 更新策略 > 滚动更新设置
+
--
include::../../../../_custom/clusterManagement/workloads/createWorkload/workloads-para-rollingUpdate_deploy.adoc[]
--
...
include::../../../../_custom/clusterManagement/workloads/createWorkload/workloads-para-selectNode_ks.adoc[]
